...
export interface SignUpFormProps {
  ...
  /**
   * Callback when sign up is successful (user is automatically signed in)
   */
 ...
 * - Auto sign-in after successful registration (no verification required)
 *
 ...
 *   onSuccess={(email) => console.log(`User ${email} signed up successfully`)}
 * />
 * ```
 */
